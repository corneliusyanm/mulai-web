...
class WeeklyMetricsViewTest(TestCase):
    ...
    def test_expiring_member_renewal(self):
        ...
        self.create_past_payment(self.existing_member_expiring, self.bronze_1_month, days_ago=32)
    ...
    def test_early_renewal(self):
        ...
        self.create_past_payment(self.existing_member_early_renewal, self.silver_3_months, days_ago=60)
    ...
    def test_installment_payment(self):
        ...
        self.create_past_payment(self.existing_member_installment, self.bronze_12_months, days_ago=120)
    ...
    def test_new_member_excluded(self):
        ...
        expiring_names = [r['member'].name for r in context.get('expiring_renewals', [])]
        early_names = [r['member'].name for r in context.get('early_renewals', [])]
        installment_names = [r['member'].name for r in context.get('installment_payments', [])]
    ...
    def test_member_who_did_not_repurchase(self):
        ...
        did_not_repurchase_names = [m.name for m in context.get('did_not_repurchase_members', [])]
    ...
    def test_statistics_calculation(self):
        ...
        self.create_past_payment(self.existing_member_expiring, self.bronze_1_month, days_ago=32)
        self.existing_member_expiring.active_until = timezone.make_aware(datetime(2025, 9, 16, 16, 59, 59))
        self.existing_member_expiring.save()
        self.create_weekly_payment(self.existing_member_expiring, self.bronze_1_month, date(2025, 9, 15))
        
        # Early renewal
        self.create_past_payment(self.existing_member_early_renewal, self.silver_3_months, days_ago=60)
        self.existing_member_early_renewal.active_until = timezone.make_aware(datetime(2025, 12, 20, 16, 59, 59))
        self.existing_member_early_renewal.save()
        self.create_weekly_payment(self.existing_member_early_renewal, self.silver_3_months, date(2025, 9, 17))
