...
from .models import Visit, Reminder
...
class ReminderAdmin(admin.ModelAdmin):
    ...
    def current_reminders_view(self, request):
        ...
        return render(request, "admin/visits/reminder/current_reminders.html", context)
    ...
    def reminder_history_view(self, request):
        ...
        return render(request, "admin/visits/reminder/reminder_history.html", context)
